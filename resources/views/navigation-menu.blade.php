            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @can('manage-users')
                        ...
                        <x-jet-nav-link href="{{ route('admin.rekenings.index') }}" :active="request()->routeIs('admin.rekenings.index')">
                            {{ __('Rekening') }}
                        </x-jet-nav-link>
                        ...
                        @if (auth()->user()->role_id == 2)
                            <x-jet-nav-link href="{{ route('pemodal.hewans.index') }}" :active="request()->routeIs('pemodal.hewans.index')">
                                {{ __('Hewan') }}
                            </x-jet-nav-link>
                        ...
                        @can('manage-courses')
                            <x-jet-nav-link href="{{ route('pengadas.hewans.index') }}" :active="request()->routeIs('pengadas.hewans.index')">
                                {{ __('Hewan') }}
                            </x-jet-nav-link>
