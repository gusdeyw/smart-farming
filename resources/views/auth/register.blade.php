    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}" x-data="{ role_id: 2 }">
            ...
            <div class="mt-4">
                ...
                <x-jet-input :value="old('foto_ktp')" id="foto_ktp" class="block mt-1 w-full" type="text" name="foto_ktp"
                    required />
            </div>
            <div class="mt-4">
                <x-jet-label for="foto_npwp" value="{{ __('Foto NPWP') }}" />
                <x-jet-input :value="old('foto_npwp')" id="foto_npwp" class="block mt-1 w-full" type="text"
